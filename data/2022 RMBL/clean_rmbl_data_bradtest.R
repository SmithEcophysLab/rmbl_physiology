...
setwd("~/Documents/rmbl_physiology/data")
rmblphys <- read.csv("average_photosynthesis_lma.csv")
rmblphys.removeNAs <- na.omit(rmblphys)
rmblphys.removeNAs$lma <- numeric(rmblphys.removeNAs$lma)

ggplot(rmblphys, aes(lma, A, colour = site)) + 
